...
### Fase 2 — CRUD de Professores e Disciplinas
...
### Fase 3 — CRUD de Turmas e Horários
...
### Fase 4 — Visualizações e integração final
...
### Fase 6 — Artigo científico 
- **Introdução** (problema resolvido)
- **Desenvolvimento** (prints de tela + explicação do funcionamento)
- **Conclusão** + revisão final das normas Unisales + link do GitHub
- Formatação final e conversão para PDF
